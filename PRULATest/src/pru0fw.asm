...
main:
	...
	// Configuration: Enable OCP, Set C28 to PRUCTRL registers, enable cycle counter
...
waitforpru1:
	...
	// into the PRU0 RAM (1+no. of 32-bit transfers) = 9 here
	SBBO   R4, R2, 12, 32
	...
	// Send notification to ARM that transfer completed
	LDI    r31, 16 + PRU0_ARM_INTERRUPT

	// Goto wait again (continuous sampling)
	//JMP    waitforpru1
